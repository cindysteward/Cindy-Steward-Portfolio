...
- *Applied ML / Computer Vision research pipeline*:	Designing and building a full, reproducible research system end-to-end: signal processing, statistical anomaly detection, a rule-based decision engine, and academic-quality reporting
- *Generative AI*:	Hands-on work with diffusion models and transformer-based pipelines
- *ML app deployment*:	Shipping small, usable interfaces around ML/statistical logic (Gradio, Streamlit, Flask) rather than leaving models in notebooks
